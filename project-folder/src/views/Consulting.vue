              ...
              <v-card flat class="transparent">
                ...
                <v-card-text>
                  <p class="text-center headline my-12">
                    Most business questions can be answered using data. Perhaps
                    some challenges you face are hard to explain to your
                    stakeholders, other might seem too advanced or simply you
                    just lack the necessary time.
                    <b style="color: #2C81D6"
                      >We bring a fresh approach to help you develop and iterate
                      fast on these ideas</b
                    >, without wasting your time with endless presentations.
                  </p>
                </v-card-text>
              </v-card>
            </v-flex>
