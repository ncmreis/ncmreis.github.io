                    ...
                    <v-flex md10 xs12 class="mt-12">
                        <v-card flat class="transparent">
                            <v-card-title primary-title class="justify-center fix layout mb-12">
                                <p class="display-2 text-center" style="font-weight: 600">Been there, done that</p>
                            </v-card-title>
                            <v-card-text>
                                <p class="text-center headline my-12">
                                    ...
                                    We believe <b>this sets us apart</b> as we can cross-apply the best practices between all of them.
                                </p>
                            </v-card-text>
                        </v-card>
                    </v-flex>
                        ...
                        <v-container grid-list-xl>
                            <v-layout row wrap align-start>
                                <v-flex v-for="type in types" sm4 xs12>
                                    <v-card flat class="transparent">
                                        <v-img height="250" contain :src="getServiceImgUrl(type.photo)" class="text-center"></v-img>
            ...
            <v-flex md10 sm12 xs12 class="mt-12">
              <v-card flat class="transparent">
                <v-card-title primary-title class="justify-center fix layout mb-2">
                  <p class="display-2 text-center" style="font-weight: 600">How we do it</p>
                </v-card-title>
                  <v-card-text>
                      <p class="text-center headline my-12">
                          Thorly is by far the <b>most fun and difficult</b> thing we faced in our professional lives so far.
                          ...
                          <template v-for="feature in features">
                              ...
                              <v-flex v-else md2 class="hidden-sm-and-down">
                                  <v-card flat class="transparent text-center">
                                      <v-card-text class="display-2 justify-center" style="margin-top: 150px">
                                          vs.
                                      </v-card-text>
                                  </v-card>
                              </v-flex>
            ...
            <v-container class="text-center">
                ...
                >
                    <v-flex md10 xs12 class="mt-12">
                        <v-card flat class="transparent">
                            <v-card-title primary-title class="justify-center fix layout mb-12">
                                <p class="display-2 text-center" style="font-weight: 600">The services for your needs</p>
                            </v-card-title>
                        </v-card>
                    </v-flex>
          ...
          features: [
              {
                  ...
                  color: '#2C81D6',
                  items: [
                      {text: 'Customized', icon: 'mdi-account-multiple-outline'},
                      ...
                      {text: 'User-centered design', icon: 'mdi-image-filter-center-focus'},
                  ]
              },
              {},
              {
                  ...
                  color: 'orangered',
                  items: [
                      {text: 'One size fits all', icon: 'mdi-account-multiple-outline'},
                      {text: 'Big & over-planned', icon: 'mdi-repeat'},
                      {text: 'End product obsession', icon: 'mdi-stairs'},
                      {text: 'Complex & jargonized', icon: 'mdi-flag'},
                      {text: 'Outsource dependency', icon: 'mdi-account-convert'},
                      {text: 'For decision makers', icon: 'mdi-image-filter-center-focus'},
                  ]
              },
              ],
        challenges: [
