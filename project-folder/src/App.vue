<template>
  <v-app>
      ...
      <v-card class="main main-raised cursor"
              hover>

          <v-toolbar v-if="scrolled" class="nav"">
              <v-toolbar-title>
...
import IntroPythonCard from './components/IntroPythonCard';
import PythonDSCard from './components/PythonDSCard';
